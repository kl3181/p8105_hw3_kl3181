...
noaa_tidy %>% 
  ...
  arrange(desc(n_obs))
```
The most common observed value is 0 centimeters of snowfall with 2008508 observations. The most common snowfall is 2.5 centimeters with 31022. It is likely these are the most common values because for most days out of the year there is no snow or some stations are less likely to have snow than others.
...
ggplot 
  ...
  average max temp over years, separately for each station
